...
#
# Generated by export_simulation on Tue Nov 19 21:40:17 -0700 2019
#
################################################################################
...
'-reset_run' switch to the './Ascii_Text_BROM.sh' script.

./Ascii_Text_BROM.sh -reset_run
...
./Ascii_Text_BROM.sh -noclean_files

For more information on the script, please type './Ascii_Text_BROM.sh -help'.
