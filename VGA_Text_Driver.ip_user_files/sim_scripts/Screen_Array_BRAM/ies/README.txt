...
#
# Generated by export_simulation on Tue Nov 19 21:40:14 -0700 2019
#
################################################################################
...
'-reset_run' switch to the './Screen_Array_BRAM.sh' script.

./Screen_Array_BRAM.sh -reset_run
...
./Screen_Array_BRAM.sh -noclean_files

For more information on the script, please type './Screen_Array_BRAM.sh -help'.
